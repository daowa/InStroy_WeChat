...
function test(){
	echo "alert(\"开始连接数据库\");";
	// 连主库
	mysqli_connect(SAE_MYSQL_HOST_M.':'.SAE_MYSQL_PORT,SAE_MYSQL_USER,SAE_MYSQL_PASS,SAE_MYSQL_DB);
	echo "alert(\"开始连接数据库2\");";
...
<head>
    ...
    <script type="text/javascript" charset="utf-8" src="./js/jquery_3.1.0.slim.min.js"></script>
...
<body>
<div>
    <h4>测试1.运营网站富媒体编辑器 2.运营网站与sae数据库连接 3.微信网页与数据库连接 4.富媒体编辑在微信网页上的显示效果</h4>
